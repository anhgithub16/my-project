...
class DB_MySQL {
    ...
    private static String USER_NAME = "root"; // Tên người dùng
    
    private static String PASS = ""; // Mật khẩu người dùng
    ...
    public static ResultSet rs ; // Biến chứa dữ liệu sau khi SELECT
    ...
    public static String[][] select(String[] columns, String table, String where) {
        ...
        if(conn != null) {
            ...
            try {
                ...
                DB_MySQL.rs = stmt.executeQuery(query);
                return convertData(DB_MySQL.rs);
