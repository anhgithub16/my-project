...
image_path = "cmtsau3.jpg"
image = cv2.imread("cmtsau9.jpg")
start = time.time()

path_config = "./pipeline.config"
path_ckpt = "C:/Users/Admin/Desktop/Newfolder/text_detection/ssd_mobilenet_v2/svcheck/ckpt-16"
path_to_labels = "./label_map.pbtxt"

detector = Detector(path_config,path_ckpt,path_to_labels)
img, original_image, coordinate_dict = detector.predict(image)
end = time.time()
print("Estimated time: ", end - start)
cv2.imwrite('coner_test1.png', img)
cv2.imshow('test', img)
cv2.waitKey(0)